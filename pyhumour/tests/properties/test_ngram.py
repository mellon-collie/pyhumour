...
class TestNgram(unittest.TestCase):
    ...
    def test_ngramTrigramValue(self):
        trigram = {('<s>', '<s>', 'this'): 1, ('<s>', 'this', 'is'): 1, ('this', 'is', 'funny'): 1, ('is', 'funny', '</s>'): 1, ('funny', '</s>', '</s>'): 2, ('<s>', '<s>', 'so'): 1, ('<s>', 'so', 'damn'): 1, ('so', 'damn', 'funny'): 1, ('damn', 'funny', '</s>'): 1}
    ...
    def test_ngramIndividualSentencesTrue(self):
        ...
        actual = [['<s>', '<s>', 'this', 'is', 'funny', '</s>', '</s>'], ['<s>', '<s>', 'so', 'damn', 'funny', '</s>', '</s>']]
